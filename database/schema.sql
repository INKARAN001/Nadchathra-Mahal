...
-- Sample Booking
-- INSERT INTO bookings (user_id, full_name, phone_number, email_address, hall, booking_date, food_type, people_count, total_amount, payment_type, payment_status, booking_status)
-- VALUES (2, 'John Doe', '9876543210', 'john@example.com', 'Hall A', '2025-11-15', 'Royal Feast', 150, 120000.00, 'CARD', 'PENDING', 'PENDING');
